...
#define SIG_TEST 35 /* we define our own signal, hard coded since SIGRTMIN is different in user and in kernel space */ 
 
void receiveData(int n, siginfo_t *info, void *unused)
{
    printf("\nreceived value(sig%i) %i\n", n,info->si_int);
